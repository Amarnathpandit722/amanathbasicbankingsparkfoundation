...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-info">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">APNA BANK <img src="../Logos/logo.webp" alt="Bank" width="50" height="50"></a>
    ...
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        <a href="history.php"><button type="button" class="btn btn-outline-primary btn-lg mb-3">See all Transaction History</button></a>
    </div>
    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="color : black;">
                                    ...
                                    <td><a href="users.php?id= <?php echo $rows['id']; ?>"> <button class="btn btn-outline-success btn">View and Transact</button></a></td>
                                </tr>
                            <?php
                            }
                            ?>
    ...
    <div class="foot">
        <footer class="bg-warning text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                ...
                <a class="text-white btn-outline-info" href="https://www.thesparksfoundationsingapore.org/" target="_blank"> The Sparks
