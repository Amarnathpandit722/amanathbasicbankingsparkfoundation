...
<body>
    ...
    <!-- Nav bar -->
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-info">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">APNA BANK <img src="../Logos/logo.webp" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2>
            <img src="../Logos/friend.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Welcoming you in the most trusted FOUNDATION Bank !</strong>
             <img src="../Logos/trust.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item ">
                <img src="../background/money.webp" width="1000" height="375" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="../background/online-banking.webp" width="1000" height="375" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="../background/rupee.webp" width="1000" height="375" class="d-block w-100" alt="...">
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3 " style="background-color: rgba(0, 0, 0, 0.2)">
                © 2021 Copyright - Made with 🧡 by Amarnath Pandit :
                <a class="text-danger btn-outline-info" href="https://www.thesparksfoundationsingapore.org/" target="_blank"> The Sparks
