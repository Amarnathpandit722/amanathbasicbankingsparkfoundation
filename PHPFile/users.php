...
<body>
    ...
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        ...
        <a href="history.php"><button type="button" class="btn btn-outline-secondary btn-lg mb-3">See all Transaction History</button></a>
    </div>
    </div>

 <!-- Table -->
 <div class="container">
        <h2 class="text-center pt-4" style="color : #ff4500;">Customer Details</h2>
            <?php
                include 'connect.php';
                $sid=$_GET['id'];
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn btn-outline-success mb-3" name="submit" type="submit" id="myBtn" > Amount Send</button>
            </div>
        </form>
    </div>    
