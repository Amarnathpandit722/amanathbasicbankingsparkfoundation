...
<div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
    <a href="money.php"><button type="button" class="btn btn-outline-warning btn-lg mb-3">Click Here to Transfer Money</button></a>
</div>
...
<tr style="color : black;">
    ...
    <div class="foot ">
        <footer class="bg-secondary mb-2 text-center text-lg-start">
            <!-- Copyright -->
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                © 2021 Copyright - Made with 🧡 by Amarnath Pandit :
                <a class="text-outline-warning" href="https://www.thesparksfoundationsingapore.org/" target="_blank"> The Sparks
